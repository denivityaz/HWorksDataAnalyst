...
2. 
    В задаче все возможные исходы броска кости включаются в объединение событий AuB - {1,2,3,4,5,6}.  
    Т к оно охватывает все возможные результаты броска, вероятность этого события равно 1
